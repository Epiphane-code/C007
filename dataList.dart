...
List<MesModules> modulesdownload=[
  MesModules (
    id_module: 8,
    id_module_user: 1,
    nom_module: 'Bases de données avec SQL',
   ...
   MesModules (
    ...
    id_module_user: 1,
    nom_module: 'React pour les débutants',
    categorie_module: 'Developpement',
    image_module: 'sql.png',
    taille_module: '550 Mo',
    duree_module: '7 heures',
    note_module: '4.3',
   ...
   MesModules (
    id_module: 8,
    id_module_user: 1,
    nom_module: 'Base de données avec SQL',
    categorie_module: 'Bases de données',
    image_module: 'sql.png',
    taille_module: '550 Mo',
    duree_module: '7 heures',
...
List<ChatBotClass> chatBot = [
  ChatBotClass(id: 1, id_user: 6, message: 'comment creer une app mobile', reponse: 'apprenez flutter d\'abord', dateMessage: DateTime(12,5,3,22,15,5) ),
  ChatBotClass(id: 2, id_user: 6, message: 'ok apprends moi alors', reponse: 'tu une fois codé', dateMessage: DateTime(12,5,3,22,16,5) ),
  ChatBotClass(id: 3, id_user: 6, message: 'jamais', reponse: 'D\'accord ne t\'inquietes pas alors', dateMessage: DateTime(12,5,3,22,17,5) ),
  ChatBotClass(id: 4, id_user: 6, message: 't\'es genial', reponse: 'vous l\'etes aussi', dateMessage: DateTime(12,5,3,22,18,5) ),
  ChatBotClass(id: 5, id_user: 6, message: 'merci', reponse: 'je vous en pris!', dateMessage: DateTime(12,5,3,22,19,5) )
];
